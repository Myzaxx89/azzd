...
RegisterNetEvent('YnS::esx:playerLoaded')
AddEventHandler('YnS::esx:playerLoaded', function(xPlayer)
	local cash, dirtycash, bank = 0, 0, 0
...
RegisterNetEvent('YnS::esx:setJob')
AddEventHandler('YnS::esx:setJob', function(job)
	SendNUIMessage({
		action = 'setInfos',
		infos = {
			{
...
RegisterNetEvent('YnS::esx:setJob2')
AddEventHandler('YnS::esx:setJob2', function(job2)
	SendNUIMessage({
		action = 'setInfos',
		infos = {
			{
...
RegisterNetEvent('YnS::esx:setAccountMoney')
AddEventHandler('YnS::esx:setAccountMoney', function(account)
...
AddEventHandler('YnS::esx_newui:updateBasics', function(basics)
	for i = 1, #basics, 1 do
...
AddEventHandler('YnS::tempui:toggleUi', function(value)
	uiFaded = value
...
AddEventHandler('YnS::korioz:switchFinished', function()
